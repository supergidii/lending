export default function StatCards({ data }) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm">
        <h3 className="text-lg font-medium text-gray-700">Total Loan Returns</h3>
        <p className="text-4xl font-bold mt-2">{formatAmount(totalReturns)}</p>
        <p className="text-sm text-gray-500 mt-1">Earnings from {completedInvestments} completed loan contributions</p>
      </div>

      <div className="bg-white p-6 rounded-lg shadow-sm">
        <h3 className="text-lg font-medium text-gray-700">Open Loan Contributions</h3>
        <p className="text-4xl font-bold mt-2">{activeInvestments}</p>
        <p className="text-sm text-gray-500 mt-1">Current open loan contributions</p>
      </div>
